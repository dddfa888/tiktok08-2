...
export const openService = (flag = false) => {
  ...
  if (!flag) {
    ...
    if (customer_service_url) {
      ...
      let href = ''
      if (isMobile()) {
        href = hostname === 'localhost' ? 'https://www.sparmalla.top/www/#/customerService' : `${origin}/www/#/customerService`
      } else {
        href = hostname === 'localhost' ? 'https://www.sparmalla.top/ww/#/login' : `${origin}/ww/#/login`
      }
