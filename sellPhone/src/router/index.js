...
const routes = [
  {
    ...
    children: [
      { path: '', redirect: '/shop' },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "verify" */ /* webpackPrefetch: true */ '@/views/login/index.vue'
          )
      },
      {
        path: '/register',
        ...
        component: () =>
          import(
            /* webpackChunkName: "verify" */ /* webpackPrefetch: true */ '@/views/register/index.vue'
          )
      },
      {
        path: '/shop',
      ...
      },
      {
        ...
        children: [
          ...
          }, //商品库
          {
            ...
            meta: { tarbar: false, level: 3 },
            component: () =>
              import('@/views/product/components/productEdit.vue')
          }, //商品库
          {
            path: 'details',
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "verifyPage" */ /* webpackPrefetch: true */ '@/views/verifyPage/index.vue'
          )
      },
      {
        // 邮箱手机认证
        ...
        component: () =>
          import(
            /* webpackChunkName: "certified" */ /* webpackPrefetch: true */ '@/views/certified/index.vue'
          )
      },
      {
        //语言设置
        ...
        component: () =>
          import(
            /* webpackChunkName: "language" */ /* webpackPrefetch: true */ '@/views/language/index.vue'
          )
      },
      {
        // 邀请活动
        ...
        component: () =>
          import(
            /* webpackChunkName: "InvitationActivity" */ /* webpackPrefetch: true */ '@/views/invitationActivity/index.vue'
          )
      },
      {
        //客服
        ...
        component: () =>
          import(
            /* webpackChunkName: "customerService" */ /* webpackPrefetch: true */ '@/views/customerService/index.vue'
          )
      },
      {
        //客服
        ...
        component: () =>
          import(
            /* webpackChunkName: "customerService" */ /* webpackPrefetch: true */ '@/views/shop/components/Service.vue'
          )
      },
      {
        //客服-第三方
        ...
        component: () =>
          import(
            /* webpackChunkName: "customerServiceOther" */ /* webpackPrefetch: true */ '@/views/customerServiceOther/index.vue'
          )
      },
      {
        // 修改头像
        ...
        component: () =>
          import(
            /* webpackChunkName: "changeAvatar" */ /* webpackPrefetch: true */ '@/views/changeAvatar/index.vue'
          )
      },
      {
        //修改登录密码
        ...
        component: () =>
          import(
            /* webpackChunkName: "changePassword" */ /* webpackPrefetch: true */ '@/views/changePassword/index.vue'
          )
      },
      {
        //设置资金密码
        ...
        component: () =>
          import(
            /* webpackChunkName: "fundsPasswordSettings" */ /* webpackPrefetch: true */ '@/views/fundsPasswordSettings/index.vue'
          )
      },
      {
        //修改资金密码
        ...
        component: () =>
          import(
            /* webpackChunkName: "changeFundsPassword" */ /* webpackPrefetch: true */ '@/views/changeFundsPassword/index.vue'
          )
      },
      {
        //绑定手机号
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "bindVerify" */ /* webpackPrefetch: true */ '@/views/bindVerify/index.vue'
          )
      },
      {
        //重置绑定
        ...
        component: () =>
          import(
            /* webpackChunkName: "resetVerify" */ /* webpackPrefetch: true */ '@/views/resetVerify/index.vue'
          )
      },
      {
        //安全中心
        ...
        component: () =>
          import(
            /* webpackChunkName: "safety" */ /* webpackPrefetch: true */ '@/views/safety/index.vue'
          )
      },
      {
        //更换绑定
        ...
        component: () =>
          import(
            /* webpackChunkName: "changeVerify" */ /* webpackPrefetch: true */ '@/views/safety/changeVerify.vue'
          )
      },
      {
        //服务条款
        ...
        component: () =>
          import(
            /* webpackChunkName: "TermsOfService" */ /* webpackPrefetch: true */ '@/views/termsOfService/index.vue'
          )
      },
      {
        //
        ...
        component: () =>
          import(
            /* webpackChunkName: "resetSuccess" */ /* webpackPrefetch: true */ '@/views/resetVerify/resetSuccess.vue'
          )
      },
      {
        //忘记密码
        ...
        component: () =>
          import(
            /* webpackChunkName: "forget" */ /* webpackPrefetch: true */ '@/views/forget/index.vue'
          )
      },
      {
        //重置登录密码
        ...
        component: () =>
          import(
            /* webpackChunkName: "resetPassword" */ /* webpackPrefetch: true */ '@/views/forget/resetPassword.vue'
          )
      },
      {
        //忘记密码修改成功
        ...
        component: () =>
          import(
            /* webpackChunkName: "passSuccess" */ /* webpackPrefetch: true */ '@/views/forget/passSuccess.vue'
          )
      },
      {
        //安全验证
        ...
        component: () =>
          import(
            /* webpackChunkName: "safeVerify" */ /* webpackPrefetch: true */ '@/views/forget/safeVerify.vue'
          )
      },
      {
        //重置邮箱/手机号
        ...
        component: () =>
          import(
            /* webpackChunkName: "resetPane" */ /* webpackPrefetch: true */ '@/views/resetPane/index.vue'
          )
      },
      {
        //设置
        ...
        component: () =>
          import(
            /* webpackChunkName: "setting" */ /* webpackPrefetch: true */ '@/views/setting/index.vue'
          )
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "personalInfo" */ /* webpackPrefetch: true */ '@/views/personalInfo/index.vue'
          )
      },
      {
        //登录密码修改成功
        ...
        component: () =>
          import(
            /* webpackChunkName: "successChange" */ /* webpackPrefetch: true */ '@/views/successChange/index.vue'
          )
      },
      {
        //refundRequest
        ...
        component: () =>
          import(
            /* webpackChunkName: "refundRequest" */ /* webpackPrefetch: true */ '@/views/refundRequest/index.vue'
          )
      },
      {
        //refundRequest
        ...
        component: () =>
          import(
            /* webpackChunkName: "RefundRequestDetails" */ /* webpackPrefetch: true */ '@/views/refundRequest/details/index.vue'
          )
      },
      {
        //名称
        ...
        component: () =>
          import(
            /* webpackChunkName: "name" */ /* webpackPrefetch: true */ '@/views/name/index.vue'
          )
      },
      {
        //电话
        ...
        component: () =>
          import(
            /* webpackChunkName: "number" */ /* webpackPrefetch: true */ '@/views/number/index.vue'
          )
      },

      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "email" */ /* webpackPrefetch: true */ '@/views/email/index.vue'
          )
      },
      {
        //搜索
        ...
        component: () =>
          import(
            /* webpackChunkName: "search" */ /* webpackPrefetch: true */ '@/views/search/index.vue'
          )
      },
      {
        path: '/:pathMatch(.*)*',
      ...
      if (!userStore.userInfo.signPdfUrl && to.name !== 'ShopContractSign') {
        if (!hasRequsetSign) {
          await sysParaSign().then((res) => {
            hasRequsetSign = true
            isSign =
              typeof res.sellerSign === 'string'
                ? JSON.parse(res.sellerSign)
                : res.sellerSign
          })
        }
        if (isSign) {
