...
<script setup>
import { ref, toRefs, computed, onMounted, nextTick, h } from 'vue'
...
const toCustomerService = () => {
  ...
  //           onClick: () => {
  //             Dialog.close()
  //             customerServiceUrl_st().then((res) => {
  //               console.log(res, 'res')
  //               router.push({
  //                 path: '/service',
  //                 query: { id: res.customer_service_url_st }
  //               })
  //             })
  //           }
  //         },
