  ...
  >
    ...
    <div class="form-content">
      <div v-if="activeType === 0" class="item">
        <div class="title">{{ t('邮箱或手机号') }}</div>
        <div class="input-content">
          <input-item v-model="formData.username" type="text" :placeholder="t('请输入邮箱或手机号')" clear />
        </div>
      </div>
      ...
      <div v-if="showAgree" class="agree-content" :class="{ 'is-ar': isArLang }">
        ...
        <p>
          ...
          <span class="link" @click="agreeVisible = true">《{{ t('用户协议') }}》</span>
        </p>
      </div>
...
const goRegister = () => {
  ...
  const href =
    hostname === 'localhost'
      ? 'https://www.sparmalla.top/promote/#/'
      : `${origin}/promote/#/`
