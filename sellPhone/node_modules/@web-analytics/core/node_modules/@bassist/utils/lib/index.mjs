...
var K = (e, i, o) => i in e ? A(e, i, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[i] = o;
var c = (e, i, o) => (K(e, typeof i != "symbol" ? i + "" : i, o), o);
const _ = {
  ...
  async cut(e) {
    return !this.isSupported || !await this.copy(e) ? !1 : (e.value = "", !0);
  },
  async read() {
    return this.isSupported ? await navigator.clipboard.readText() : "";
  },
  async write(e) {
    return this.isSupported ? (await navigator.clipboard.writeText(e), !0) : !1;
  }
};
function a() {
...
], l = typeof window < "u", O = !l, m = /iPhone|phone|android|iPod|pad|iPad/i;
function L() {
  return l ? m.test(a()) : !1;
}
function H() {
...
const v = /Android/i.test(a()), y = /iPhone|iPod|iPad|iOS/i.test(a()), N = /uni-app|html5plus/.test(a()), F = /MicroMessenger/i.test(a()), X = /\sQQ|mqqbrowser|qzone|qqbrowser/i.test(a()), I = /mqqbrowser|qqbrowser/i.test(a()), E = /qzone\/.*_qz_([\d.]+)/i.test(a()), P = /(weibo).*weibo__([\d.]+)/i.test(a()), $ = /(baiduboxapp)\/([\d.]+)/i.test(a());
function B(e, { immediate: i } = { immediate: !0 }) {
  l && (i && window.addEventListener("load", e, !1), window.addEventListener(
...
function d(e, i) {
  return M(e) ? Object.prototype.hasOwnProperty.call(e, i) : !1;
}
const u = {};
class b {
  constructor(i) {
    ...
    this.data = {};
    const o = d(u, i);
    this.data = o ? u[i].data : {}, o || (u[i] = this);
  }
  get length() {
  ...
  getItem(i) {
    return d(this.data, i) ? this.data[i] : null;
  }
  setItem(i, o) {
    this.data[i] = o;
  }
  removeItem(i) {
    d(this.data, i) && delete this.data[i];
  }
  key(i) {
    const o = Object.keys(this.data);
...
class W {
  constructor(i, o) {
    c(this, "prefix");
    c(this, "storage");
    this.prefix = i, this.storage = l ? window[o] : new b(i);
  }
  get(i) {
    const o = this.storage.getItem(`${this.prefix}-${i}`);
    if (!o)
      return o;
    try {
      return o === "true" ? !0 : o === "false" ? !1 : o === "null" ? null : o === "undefined" ? void 0 : JSON.parse(o);
    } catch {
      return o;
    }
  }
  set(i, o) {
    try {
      const r = k(o) === "string" ? o : JSON.stringify(o);
      this.storage.setItem(`${this.prefix}-${i}`, r);
    } catch (t) {
      console.log(t);
    }
  }
  remove(i) {
    this.storage.removeItem(`${this.prefix}-${i}`);
  }
  clear() {
    this.list().forEach((o) => {
      this.remove(o);
  ...
  list() {
    if (!this.prefix)
      return [];
    const i = [], o = this.storage.length;
    for (let t = 0; t < o; t++) {
      const r = this.storage.key(t);
      r != null && r.startsWith(this.prefix) && i.push(r.replace(`${this.prefix}-`, ""));
    }
    return i;
  }
}
class U extends W {
  constructor(i) {
    super(i, "localStorage");
  }
}
class V extends W {
  constructor(i) {
    super(i, "sessionStorage");
  }
}
function x() {
  return l ? window.matchMedia("(prefers-color-scheme: dark)").matches : !1;
}
function z() {
  return l ? window.matchMedia("(prefers-color-scheme: light)").matches : !1;
}
function Q() {
  if (x())
    return "dark";
...
class q {
  ...
  getMimeType(i) {
    try {
      return i.startsWith("data") && i.includes("base64") ? i.split(",")[0].replace(/data:(.*);base64/, "$1") : this.mime.getType(i) || "";
    } catch {
      return "";
    }
  }
  getExtensionFromMimeType(i) {
    try {
      return this.mime.getExtension(i) || "";
    } catch {
      return "";
    }
  }
  getExtension(i) {
    try {
      const o = this.getMimeType(i);
      return this.getExtensionFromMimeType(o);
    } catch {
      return "";
    }
  }
...
function D(e, i = !1) {
  return e = e ? String(e) : "", e = e.replace(/[^\d]/g, ""), e && !i && (e = parseInt(e)), String(e);
}
function j(e) {
  if (e = String(e), !e)
    return "0.00";
  const i = e.split("."), o = i[0], t = i[1];
  return i.length === 1 ? `${o}.00` : t.length === 1 ? `${e}0` : Number(e).toFixed(2);
}
function Z(e, i) {
  return String(e).length > i ? String(e).slice(0, i) + " ..." : String(e);
}
function w([e, ...i]) {
  return e ? e.toUpperCase() + i.join("") : "";
}
function J(e) {
  return e ? e.replace(/([A-Z])/g, " $1").trim().split(" ").join("-").replace(/_/g, "-").toLowerCase() : "";
}
function g([e, ...i]) {
  return e ? (e.toLowerCase() + i.join("")).replace(/[-_](\w)/g, (t, r) => r ? r.toUpperCase() : "") : "";
}
function Y(e) {
  return e ? w(g(e)) : "";
}
function ee(e) {
  const i = /[\\^$.*+?()[\]{}|]/g, o = RegExp(i.source);
  return e && o.test(e) ? e.replace(i, "\\$&") : e;
}
function h(e) {
  ...
  if (Array.isArray(e))
    return e.map((t) => h(t));
  const i = Object.keys(e).sort(), o = {};
  return i.forEach((t) => {
    o[t] = h(e[t]);
  }), o;
}
function ie({ primaryKey: e, list: i }) {
...
function oe(e, i) {
  ...
  const o = {};
  for (const t in e)
    d(e, t) && !i.includes(t) && (o[t] = e[t]);
  return o;
}
function te({ type: e, id: i, resource: o }) {
  return new Promise((t, r) => {
    ...
    function s(n) {
      n.addEventListener("load", t), n.addEventListener("error", r), n.addEventListener("abort", r);
    }
    switch (e) {
      case "js": {
        const n = document.createElement("script");
        n.id = i, n.async = !0, n.src = o, s(n), document.head.appendChild(n);
        break;
      }
      case "css": {
        const n = document.createElement("link");
        n.id = i, n.rel = "stylesheet", n.href = o, s(n), document.head.appendChild(n);
        break;
      }
      case "style": {
        const n = document.createElement("style");
        n.id = i, s(n), document.head.appendChild(n), n.appendChild(document.createTextNode(o));
        break;
      }
    }
  });
...
function re(e) {
  ...
  return Object.keys(i).forEach((r) => {
    r !== "path" && (o[r] = i[r]);
  }), { path: i.path || "", params: o };
}
function ne(e, i) {
  return S(i)[e] || "";
}
function ae(e) {
  return M(e) ? Object.keys(e).map((i) => `${i}=${encodeURIComponent(String(e[i]))}`).join("&") : "";
}
function T(e = 0, i = 100, o = "round") {
  return Math[o](Math.random() * (i - e) + e);
}
function le(e = 10) {
...
function ce(e) {
  ...
  for (let i = e.length - 1; i > 0; i--) {
    const o = Math.floor(Math.random() * (i + 1)), t = e[i];
    e[i] = e[o], e[o] = t;
  }
  return e;
}
function de() {
  const e = T(0, p.length - 1);
  return p[e];
}
function Me(e) {
  return /^1[3456789]\d{9}$/.test(String(e));
}
function ue(e) {
...
function pe(e) {
  const i = /^([1-6][1-9]|50)\d{4}(18|19|20)\d{2}((0[1-9])|10|11|12)(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/, o = /^([1-6][1-9]|50)\d{4}\d{2}((0[1-9])|10|11|12)(([0-2][1-9])|10|20|30|31)\d{3}$/;
...
const Te = f("development"), Ae = f("test"), Ke = f("production");
export {
  q as FileInfo,
  U as LocalStorage,
  V as SessionStorage,
  ...
  oe as excludeFields,
  D as extractNumber,
  re as extractQueryInfo,
  j as formatAmount,
  k as getDataType,
  Q as getPrefersColorScheme,
  ne as getQuery,
  G as getRuntimeEnv,
  a as getUserAgent,
  d as hasKey,
  ...
  T as randomNumber,
  le as randomString,
  de as randomUserAgent,
  Se as runtimeEnv,
  ce as shuffle,
  R as sleep,
  h as sortKeys,
  ae as stringifyQuery,
  ie as unique,
  p as userAgents,
  B as watchResize
};
