...
// node_modules/@lucky-canvas/vue/node_modules/vue-demi/lib/index.esm.js
var isVue2 = false;

// node_modules/@lucky-canvas/vue/dist/index.esm.js
var n = function() {
  return n = Object.assign || function(t) {
    for (var e, i = 1, n2 = arguments.length; i < n2; i++)
      for (var r2 in e = arguments[i])
        Object.prototype.hasOwnProperty.call(e, r2) && (t[r2] = e[r2]);
    return t;
  ...
  function a2(o3) {
    return function(a3) {
      return function(o4) {
        ...
        for (; s2; )
          try {
            if (i = 1, n2 && (r2 = 2 & o4[0] ? n2.return : o4[0] ? n2.throw || ((r2 = n2.return) && r2.call(n2), 0) : n2.next) && !(r2 = r2.call(n2, o4[1])).done)
              return r2;
...
function c(t, e) {
  for (var i = 0, n2 = e.length, r2 = t.length; i < n2; i++, r2++)
    t[r2] = e[i];
  return t;
}
Array.prototype.includes || Object.defineProperty(Array.prototype, "includes", { value: function(t, e) {
  ...
  for (var r2, o2, s2 = 0 | e, a2 = Math.max(s2 >= 0 ? s2 : n2 - Math.abs(s2), 0); a2 < n2; ) {
    if ((r2 = i[a2]) === (o2 = t) || "number" == typeof r2 && "number" == typeof o2 && isNaN(r2) && isNaN(o2))
      return true;
    a2++;
  }
  return false;
...
var d = function(t) {
  if ("string" != typeof t)
    return false;
  if ("transparent" === (t = t.toLocaleLowerCase().trim()))
    return false;
  var e;
  if (/^rgba/.test(t) && 0 === (null === (e = /([^\s,]+)\)$/.exec(t)) ? 0 : "object" == typeof e ? NaN : "number" == typeof e ? e : "string" == typeof e ? "%" === e[e.length - 1] ? Number(e.slice(0, -1)) / 100 : Number(e) : NaN))
    return false;
  return true;
};
var p = function(t, e) {
  ...
  for (var c2 in h3)
    h3[c2] = u(t, c2) && l(t[c2], "string", "number") ? e(t[c2]) : h3[c2];
  return [r2, o2, s2, a2];
};
var g = function(t) {
...
var v = function(t, e, i, n2) {
  ...
  for (var r2 = "", o2 = [], s2 = t.measureText("...").width, a2 = 0; a2 < e.length; a2++) {
    ...
    if (n2 === o2.length + 1 && (h3 += s2), c2 < 0)
      return o2;
    if (h3 > c2 && (o2.push(r2.slice(0, -1)), r2 = e[a2]), n2 === o2.length)
...
function C(t) {
  if (t && "object" == typeof t)
    return "__luckyOb__" in t ? t.__luckyOb__ : new S(t);
}
function z(t, e, i) {
...
var $ = function() {
  ...
  return t.prototype.resize = function() {
    ...
    var t2 = this.config;
    if (window)
      return this.rAF = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(t3) {
    ...
    return void 0 === i && (i = "$resolve"), new Promise(function(r2, o2) {
      if (t2 || o2("=> '" + e.src + "' 不能为空或不合法"), "WEB" !== n2.config.flag)
        return e[i] = r2, void (e.$reject = o2);
      var s2 = new Image();
      s2.onload = function() {
        return r2(s2);
      }, s2.onerror = function() {
    ...
    for (var i, n2 = [], r2 = 2; r2 < arguments.length; r2++)
      n2[r2 - 2] = arguments[r2];
    var o2 = this.config, s2 = o2.flag, a2 = o2.dpr;
    if (["WEB", "MP-WX"].includes(s2))
      i = e;
    else {
      if (!["UNI-H5", "UNI-MP", "TARO-H5", "TARO-MP"].includes(s2))
        return console.error("意料之外的 flag, 该平台尚未兼容!");
      i = e.path;
    }
    if (!i.canvas)
      return 8 === n2.length && (n2 = n2.map(function(t3, e2) {
    ...
    if (!u(this, "_offscreenCanvas") && (window && window.document && "WEB" === this.config.flag ? this._offscreenCanvas = document.createElement("canvas") : this._offscreenCanvas = this.config.offscreenCanvas, !this._offscreenCanvas))
    ...
    if (0 !== r2) {
      if (-1 !== o2) {
        ...
        if (1 === r2 || l2 < a2) {
          ...
          2 === r2 ? (f2 += c2 % 360, void 0 !== o2 && o2 >= 0 && (this.step = 3, this.stopDeg = 0, this.endDeg = 0)) : 3 === r2 ? (f2 = T(u2, this.stopDeg, this.endDeg, h3), u2 >= h3 && (this.step = 0)) : this.stop(-1);
        this.rotateDeg = f2, this.draw(), n2(this.run.bind(this, t2 + 1));
      }
    } else
      null === (e2 = this.endCallback) || void 0 === e2 || e2.call(this, this.prizes.find(function(t3, e3) {
        return e3 === o2;
      }) || {});
  ...
  return o(e, t), e.prototype.resize = function() {
    ...
    return r2.includes("linear-gradient") && (r2 = function(t3, e3, i2, n3, r3, o3) {
      ...
      if (a2.includes("deg")) {
        ...
        a2.includes("top") ? h3 = [e3, i2 + r3, e3, i2] : a2.includes("bottom") ? h3 = [e3, i2, e3, i2 + r3] : a2.includes("left") ? h3 = [e3 + n3, i2, e3, i2] : a2.includes("right") && (h3 = [e3, i2, e3 + n3, i2]);
    ...
    if (0 !== r2) {
      if (-1 !== s2) {
        ...
        if (1 === r2 || u2 < h3) {
          ...
          2 === r2 ? (d2 += l2 % o2.length, void 0 !== s2 && s2 >= 0 && (this.step = 3, this.stopIndex = 0, this.endIndex = 0)) : 3 === r2 ? (d2 = T(f2, this.stopIndex, this.endIndex, c2), f2 >= c2 && (this.step = 0)) : this.stop(-1);
  ...
  return o(e, t), e.prototype.resize = function() {
    ...
    this._offscreenCanvas = b2, this.slots.forEach(function(n3, r3) {
      var o3 = h3 * r3, s3 = c2 * r3, a3 = 0, g3 = function(t3, e3) {
        for (var i2 = {}, n4 = [], r4 = 0; r4 < t3.length; r4++)
          i2[r4] = t3[r4];
    ...
    this.endTime = Date.now(), this.slots.forEach(function(e3, o2) {
      var s2 = e3.order;
      if (s2.length)
        for (var a2 = e3.speed || i.speed, h3 = e3.direction || i.direction, c2 = s2.findIndex(function(t3) {
          return t3 === n2[o2];
    ...
    if (0 !== this.step && 3 !== this.step) {
      if ("number" == typeof t2)
        this.prizeFlag = new Array(this.slots.length).fill(t2);
      else {
        if (!l(t2, "array"))
          return this.stop(-1), console.error("stop() 无法识别的参数类型 " + typeof t2);
        if (t2.length !== this.slots.length)
          return this.stop(-1), console.error("stop([" + t2 + "]) 参数长度的不正确");
        this.prizeFlag = t2;
      }
        ...
        l2.forEach(function(e3, i2) {
          ...
          if (r3 && r3.length) {
            ...
            if (1 === s2 || d2 < u2) {
              ...
              y3 = (m3 + g3 * v3) % o3, (null == a2 ? void 0 : a2.length) === l2.length && (n2.step = 3, n2.stopScroll = [], n2.endScroll = []);
            else if (3 === s2 && p2) {
...
var P = function(i, r2, o2) {
  if (void 0 === r2 && (r2 = {}), isVue2)
    return h(i, r2, o2);
  var s2 = r2.props, a2 = r2.domProps, h3 = r2.on, c2 = function(t, e) {
    var i2 = {};
    for (var n2 in t)
      Object.prototype.hasOwnProperty.call(t, n2) && e.indexOf(n2) < 0 && (i2[n2] = t[n2]);
    if (null != t && "function" == typeof Object.getOwnPropertySymbols) {
      var r3 = 0;
      for (n2 = Object.getOwnPropertySymbols(t); r3 < n2.length; r3++)
        e.indexOf(n2[r3]) < 0 && Object.prototype.propertyIsEnumerable.call(t, n2[r3]) && (i2[n2[r3]] = t[n2[r3]]);
    }
    return i2;
