...
var P = vi ? window : {};
var Ti = vi && P.document.documentElement ? "ontouchstart" in P.document.documentElement : false;
var Oi = vi ? "PointerEvent" in P : false;
var w = "cropper";
var Ni = "all";
var ct = "crop";
var lt = "move";
...
var oi = "se";
var pi = "sw";
var ki = "".concat(w, "-crop");
var Wi = "".concat(w, "-disabled");
var T = "".concat(w, "-hidden");
var Ui = "".concat(w, "-hide");
var Pt = "".concat(w, "-invisible");
var hi = "".concat(w, "-modal");
var Di = "".concat(w, "-move");
var si = "".concat(w, "Action");
var di = "".concat(w, "Preview");
var Si = "crop";
var mt = "move";
var ht = "none";
var Mi = "crop";
...
var ji = "cropstart";
var Vi = "dblclick";
var qt = Ti ? "touchstart" : "mousedown";
var Xt = Ti ? "touchmove" : "mousemove";
var Ht = Ti ? "touchend touchcancel" : "mouseup";
var $i = Oi ? "pointerdown" : qt;
var Gi = Oi ? "pointermove" : Xt;
var Fi = Oi ? "pointerup pointercancel" : Ht;
var Qi = "ready";
var Zi = "resize";
var Ki = "wheel";
var Ai = "zoom";
  ...
  cropStart: function(i) {
    ...
    if (!(this.disabled || (i.type === "mousedown" || i.type === "pointerdown" && i.pointerType === "mouse") && (u(a) && a !== 1 || u(t) && t !== 0 || i.ctrlKey))) {
      ...
      i.changedTouches ? D(i.changedTouches, function(c) {
        ...
        originalEvent: i,
        action: p
      }) !== false && (i.preventDefault(), this.action = p, this.cropping = false, p === ct && (this.cropping = true, j(this.dragBox, hi)));
    }
  },
  cropMove: function(i) {
    var a = this.action;
    if (!(this.disabled || !a)) {
      ...
      i.preventDefault(), ai(this.element, zi, {
        ...
        y(t[o.identifier] || {}, mi(o, true));
      }) : y(t[i.pointerId || 0] || {}, mi(i, true)), this.change(i));
    }
  },
  cropEnd: function(i) {
    if (!this.disabled) {
      ...
      }) : delete t[i.pointerId || 0], a && (i.preventDefault(), Object.keys(t).length || (this.action = ""), this.cropping && (this.cropping = false, ii(this.dragBox, hi, this.cropped && this.options.modal)), ai(this.element, Ei, {
        originalEvent: i,
        action: a
      }));
    }
...
var ga = {
  change: function(i) {
    var a = this.options, t = this.canvasData, o = this.containerData, n = this.cropBoxData, p = this.pointers, c = this.action, m = a.aspectRatio, l = n.left, r = n.top, s = n.width, d = n.height, v = l + s, f = r + d, b = 0, g = 0, M = o.width, z = o.height, k = true, q;
    ...
    switch (c) {
      ...
      case ei:
        if (m) {
          ...
          x(Y), x(F), h.x >= 0 ? v < M ? s += h.x : h.y <= 0 && r <= g && (k = false) : s += h.x, h.y <= 0 ? r > g && (d -= h.y, r += h.y) : (d -= h.y, r += h.y);
      ...
      case ni:
        if (m) {
          ...
          x(Y), x(Q), h.x <= 0 ? l > b ? (s -= h.x, l += h.x) : h.y <= 0 && r <= g && (k = false) : (s -= h.x, l += h.x), h.y <= 0 ? r > g && (d -= h.y, r += h.y) : (d -= h.y, r += h.y);
      ...
      case pi:
        if (m) {
          ...
          x(K), x(Q), h.x <= 0 ? l > b ? (s -= h.x, l += h.x) : h.y >= 0 && f >= z && (k = false) : (s -= h.x, l += h.x), h.y >= 0 ? f < z && (d += h.y) : d += h.y;
      ...
      case oi:
        if (m) {
          ...
          x(K), x(F), h.x >= 0 ? v < M ? s += h.x : h.y >= 0 && f >= z && (k = false) : s += h.x, h.y >= 0 ? f < z && (d += h.y) : d += h.y;
      ...
      case ct:
        ...
        q = bt(this.cropper), l = O.startX - q.left, r = O.startY - q.top, s = n.minWidth, d = n.minHeight, h.x > 0 ? c = h.y > 0 ? oi : ei : h.x < 0 && (l -= s, c = h.y > 0 ? pi : ni), h.y < 0 && (r -= d), this.cropped || (B(this.cropBox, T), this.cropped = true, this.limited && this.limitCropBox(true, true));
        break;
    }
...
var xa = {
  crop: function() {
    return this.ready && !this.cropped && !this.disabled && (this.cropped = true, this.limitCropBox(true, true), this.options.modal && j(this.dragBox, hi), B(this.cropBox, T), this.setCropBoxData(this.initialCropBoxData)), this;
  },
  reset: function() {
  ...
  clear: function() {
    return this.cropped && !this.disabled && (y(this.cropBoxData, {
      ...
      width: 0,
      height: 0
    }), this.cropped = false, this.renderCropBox(), this.limitCanvas(true, true), this.renderCanvas(), B(this.dragBox, hi), j(this.cropBox, T)), this;
  },
  replace: function(i) {
  ...
  enable: function() {
    return this.ready && this.disabled && (this.disabled = false, B(this.cropper, Wi)), this;
  },
  disable: function() {
    return this.ready && !this.disabled && (this.disabled = true, j(this.cropper, Wi)), this;
  },
  destroy: function() {
    var i = this.element;
  ...
  setCanvasData: function(i) {
    ...
    return this.ready && !this.disabled && J(i) && (u(i.left) && (a.left = i.left), u(i.top) && (a.top = i.top), u(i.width) ? (a.width = i.width, a.height = i.width / t) : u(i.height) && (a.height = i.height, a.width = i.height * t), this.renderCanvas(true)), this;
  },
  ...
  setCropBoxData: function(i) {
    ...
    return this.ready && this.cropped && !this.disabled && J(i) && (u(i.left) && (a.left = i.left), u(i.top) && (a.top = i.top), u(i.width) && i.width !== a.width && (o = true, a.width = i.width), u(i.height) && i.height !== a.height && (n = true, a.height = i.height), t && (o ? a.height = a.width / t : n && (a.width = a.height * t)), this.renderCropBox()), this;
  },
  getCroppedCanvas: function() {
    ...
    var z = i.imageSmoothingEnabled, k = z === void 0 ? true : z, q = i.imageSmoothingQuality;
...
var yt = function() {
  function e(i) {
    ...
    this.element = i, this.options = y({}, it, J(a) && a), this.cropped = false, this.disabled = false, this.pointers = {}, this.ready = false, this.reloading = false, this.replaced = false, this.sized = false, this.sizing = false, this.init();
  }
  return St(e, [{
    key: "init",
    value: function() {
    ...
    value: function(a) {
      ...
      if (!!a) {
        ...
        }, n.checkCrossOrigin && at(a) && o.crossOrigin && (a = et(a)), p.open("GET", a, true), p.responseType = "arraybuffer", p.withCredentials = o.crossOrigin === "use-credentials", p.send();
      }
    }
  }, {
    key: "read",
...
var I = Dt ? navigator.userAgent.toLowerCase() : "";
var Mt = /iPhone|phone|android|iPod|pad|iPad/i;
Mt.test(I);
Mt.test(I);
/Android/i.test(I);
...
`;
var Oa = `.vue--picture-cropper__wrap{width:100%;height:100%;margin:0}.vue--picture-cropper__img{display:block;width:auto;height:auto;max-width:100%;max-height:100%}.vue--picture-cropper__wrap-round .cropper-view-box,.vue--picture-cropper__wrap-round .cropper-face{border-radius:50%}
`;
Et({
  type: "style",
  id: "cropperjs",
