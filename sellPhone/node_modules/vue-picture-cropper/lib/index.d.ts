 ...
 */
export declare namespace Cropperjs {
...
declare class Cropper {
	constructor(element: HTMLImageElement, options?: Cropperjs.Options<HTMLImageElement>);
	constructor(element: HTMLCanvasElement, options?: Cropperjs.Options<HTMLCanvasElement>);
	clear(): Cropper;
	crop(): Cropper;
	destroy(): Cropper;
	disable(): Cropper;
	...
	getCroppedCanvas(options?: Cropperjs.GetCroppedCanvasOptions): HTMLCanvasElement;
