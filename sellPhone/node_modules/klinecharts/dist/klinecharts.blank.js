...
function logTag() {
  {
    console.log('%c❤️ Welcome to klinecharts. Version is 8.6.3', 'border-radius:2px;border:dashed 1px #2196F3;padding:26px 20px;font-size:14px;color:#2196F3');
  }
}
...
var Overlay = /*#__PURE__*/function () {
  ...
  _createClass(Overlay, [{
    ...
    value: function checkEventCoordinateOn(coordinate) {}
...
var YAxisOverlayView = /*#__PURE__*/function (_View) {
  ...
  _createClass(YAxisOverlayView, [{
    ...
    value: function _drawCrossHairLabel() {
      ...
      var rectY = crosshair.y - borderSize - crosshairHorizontalTextOptions.paddingTop - crosshairHorizontalTextOptions.size / 2;
      // 绘制y轴文字外的边框
...
var XAxisOverlayView = /*#__PURE__*/function (_View) {
  ...
  _createClass(XAxisOverlayView, [{
    ...
    value: function _drawCrosshairLabel() {
      ...
      var labelX = crosshair.realX - labelWidth / 2;
      ...
      renderStrokeFillRoundRect(this._ctx, crosshairVerticalTextOptions.backgroundColor, crosshairVerticalTextOptions.borderColor, borderSize, rectX, 0, rectWidth, rectHeight, crosshairVerticalTextOptions.borderRadius);
      // 绘制轴上的提示文字
      this._ctx.textBaseline = 'top';
...
var ZoomScrollEventHandler = /*#__PURE__*/function (_EventHandler) {
  ...
  function ZoomScrollEventHandler(chartStore) {
    ...
    _this = _super.call(this, chartStore);
    // 惯性滚动开始时间
    _this._flingStartTime = null;
    // 惯性滚动定时器
    _this._flingScrollTimerId = null;
    // 开始滚动时坐标点
    _this._startScrollCoordinate = null;
    // 开始触摸时坐标
    _this._touchCoordinate = null;
    // 是否是取消了十字光标
    _this._touchCancelCrosshair = false;
    // 是否缩放过
    _this._touchZoomed = false;
    // 用来记录捏合缩放的尺寸
    _this._pinchScale = 1;
    return _this;
  }
...
// 默认技术指标窗口高度
var DEFAULT_TECH_PANE_HEIGHT = 100;

// 技术指标窗口id前缀
var TECH_PANE_ID_PREFIX = 'tech_pane_';

// 图形id前缀
var SHAPE_ID_PREFIX = 'shape_';

// 注解id前缀
var ANNOTATION_ID_PREFIX = 'an_';
