    ...
    <div class="app-container">
      <div class="footer-wrapper flex-start">
        <div class="footer-title flex-start">
          ...
          ></el-input>
          <div class="sub" @click="subScription">{{ $t("message.home.subscription") }}</div>
        </div>
          ...
          <div class="footer-nav-item" v-for="(item, index) in linkNav" :key="index">
            ...
            <ul>
              ...
              >
                ...
                >{{ $t("message.home.businessEmail") }}: Shopify@Shopify.com</div>
      ...
      <div class="footer-wrapper">
        <div class="flex-start sec">
          ...
          <div class="argos">
            ...
            <div
              class="right"
              v-if="itemname !== 'Inchoi' && itemname !== 'Tongda' && itemname !== 'FamilyMart' && itemname !== 'Hive' && itemname !== 'Green Mall'&& itemname !== 'SM-wholesale shop' && itemname !== 'INT Overstock' && itemname !== 'Spar' && itemname !=='Shopify'"
            >
        ...
        <div
          ...
          v-if="itemname !== 'Mbuy' && itemname !== 'Hive'&& itemname !== 'Green Mall'&&itemname !== 'INT Overstock' && itemname !== 'Spar'"
        >
      ...
      <div class="footer-bottom" v-if="itemname !== 'INT Overstock'">
        ...
        >{{ itemname !== 'TikTok'?$t("message.home.footTip", { name: itemname }):$t("message.home.footTipTikTok") }}</p>
        <p
          style="text-align:center"
        >Shopify is headquartered in Ottawa, 151 O'Connor Street, Ground Floor, Canada, and has 6 office locations.</p>
      </div>
      <div class="footer-bottom" v-else>
        <p style="text-align: center; margin-bottom: 15px">© Copyright 2023, overstock8.me®, Inc.</p>
