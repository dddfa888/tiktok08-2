            ...
            <van-swipe-item v-for="page in prodctPage" :key="page">
              <div class="swipe-product">
                ...
                >
                  ...
                  <div class="content">
                    <span class="price">${{ priceFormat(item.discountPrice || item.sellingPrice) }}</span>
          ...
          >
            <div class="top">
              ...
              <div class="content">
                ...
                <div
                  :class="['button', ['Laz', 'TikTokMall', 'INT Overstock', 'TikTok-Wholesale', 'AntMall','Spar'].includes(itemName) && 'distinguish_btn']"
                  @click="jumpShop(item)"
                  :style="buttonStyle"
                >{{ $t("访问商店") }} &nbsp;></div>
              </div>
  ...
  computed: {
    logo() {
      if (this.itemName == "EShop") {
        return require(`@/assets/${process.env.VUE_APP_ITEM_NAME}/logo-h.${
