  ...
  <div class="lang-content">
    <el-dropdown trigger="click">
      ...
      <el-dropdown-menu slot="dropdown">
        ...
        <el-dropdown-item>
          <div class="lang-item" @click="changeLang(ES_LANGUAGE_MAP.bxpt)">
            <img
                :src="langIcon[ES_LANGUAGE_MAP.bxpt]"
                :alt="ES_LANGUAGE_MAP.bxpt"
                style="width: 18px"
            />
...
import bxptIcon from "@/assets/image/lang-icon/bxpt.png";
