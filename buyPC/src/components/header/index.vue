    ...
    >
      <div class="header-top flex-between app-container">
        <div
          ...
          @click="goto('/')"
          :style="itemname == 'TikTok' ? 'height:50px': itemname == 'SM-wholesale shop'? 'width:220px':'' "
        >
          <img
            ...
            :style="itemname == 'SM-wholesale shop'? 'width:220px;margin-right:auto':itemname =='TikTok'?'height:38.2px ;width:160px ':itemname =='Spar'?'width:100%': 'width:50px'"
          />
        </div>
