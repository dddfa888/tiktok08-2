<template>
	<div>
		...
		<el-dialog title="属性名称" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
			<div class="newadditem">
				<span>属性名称：</span>
				<el-input v-model="attributeName" placeholder="请输入属性名称"></el-input>
			</div>
			<div class="newadditem">
				<span>排序</span>
				<el-input v-model="attributeSort" placeholder="请输入排序" oninput="value=value.replace(/[^\d]/g,'')">
				</el-input>
			</div>
		...
		<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" border align="center"
			...
			<el-table-column prop="attrCount" label="规格数量" width="140" align="center">
			</el-table-column>
			<el-table-column prop="sort" label="排序" width="140" align="center">
			</el-table-column>
			<el-table-column label="设置" width="200" align="center">
				<template slot-scope="scope">
					<el-button size="small" type="primary" @click="goSpeci(scope.row)" plain>规格列表</el-button>
				</template>
			</el-table-column>
      ...
      <el-button @click="toggleSelection()">取消选择</el-button>
		...
		<el-dialog title="编辑" :visible.sync="dialogEdit" width="30%" :before-close="handleClose">
			...
			<div class="newadditem">
				<span>排序</span>
				<el-input v-model="changeSort" placeholder="请输入排序" oninput="value=value.replace(/[^\d]/g,'')">
				</el-input>
			</div>
			<span slot="footer" class="dialog-footer">
