...
public class AdminSellerServiceImpl extends HibernateDaoSupport implements AdminSellerService {
    ...
    public Page pagedQuery(int pageNo, int pageSize, String name_para, String loginPartyId, String sellerId, String sellerName, String startTime,
        ...
        queryString.append(" wallet.MONEY money, wallet.MONEY_AFTER_FROZEN moneyAfterFrozen,wallet.FROZEN_STATE frozenState, s.REC_TIME recTime, s.FREEZE freeze, ");
        ...
        queryString.append(" party_parent.USERNAME username_parent, kyc.REMARK remark, party.REMARKS remarks,s.SCORE score, ");
...
// TODO 删除了缺失字段       wallet.MONEY_AFTER_FROZEN moneyAfterFrozen,
