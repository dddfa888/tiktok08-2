...
public class WithdrawController extends BaseAction {
    ...
    public Object getWithdrawLimitConfig() {
        ...
        try {
            ...
            Double withdrawAmountMin3 = sysparaService.find("withdraw_limit3").getDouble();
            Double withdrawAmountMax3 = sysparaService.find("withdraw_limit_max3").getDouble();
            ...
            data.put("withdrawAmountMin3", withdrawAmountMin3);
            data.put("withdrawAmountMax3", withdrawAmountMax3);
...
//			}
            ...
            if("zfb".equalsIgnoreCase(channel)){
                ...
                withdrawalMin = sysparaService.find("withdraw_limit3").getDouble();
                withdrawalMax = sysparaService.find("withdraw_limit_max3").getDouble();
            }else
            if (Arrays.asList("wx").contains(channel.toLowerCase())) {
