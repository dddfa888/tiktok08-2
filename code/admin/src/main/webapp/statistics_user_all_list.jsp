					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal"
								action="<%=basePath%>normal/adminUserAllStatisticsAction!exchangeList2.action"
...
<%--											style="text-align: center; vertical-align: middle;">店铺ID</td>--%>
										...
										<td rowspan="2">待发佣金</td>
										<td rowspan="2">店铺利润</td>
...
<%--													<fmt:formatNumber value="${item.withdrawCommission}" pattern="#0.00" />/--%>
											...
											<td><fmt:formatNumber value="${item.rebate}" pattern="#0.00" /></td>
											<td>${item.remarks}</td>
										</tr>
									</c:forEach>
								</tbody>
