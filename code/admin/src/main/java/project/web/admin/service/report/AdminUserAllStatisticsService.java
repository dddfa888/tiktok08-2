...
public interface AdminUserAllStatisticsService {
	...
	Map<String, Object> queryRebateBySellerIds(List<String> sellerIds , String startTime , String endTime);
	/**
	 * 用户报表
	 */
	Page userReports(int pageNo, int pageSize,String startTime,String endTime,String loginPartyId,
